...
with open(input_file_path, "r") as input_file:
    ...
    for row in reader:
        ...
        # Check the conditions to label the traffic
        # This part needs modification to classify the traffic based on the 
        # conditions noticed during Ground Truth Investigation
        
        if modified_row["Dst Port"] == "22" and modified_row["Packets"] == "1" and modified_row["Data bytes"] == "5" and int(modified_row["Bytes"]) > 10:
            label = "Malicious"
        else:
            label = "Benign"
